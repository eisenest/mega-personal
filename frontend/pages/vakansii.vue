...
<template>
  ...
  <VacanciesSection :title="'Вакансии'"
                    :subtitle="'Большой выбор наших  вакансий можно разделить по направлениям'"
  ...
  <div class="services__title-content headline">
    ...
    <div class="services__description">
      <p>
        Наши специалисты с радостью помогут вам найти подходящую работу и ответят на все ваши вопросы о условиях и деталях.
      </p>
    </div>
  </div>
